defmodule ResidentialWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ResidentialWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ResidentialWeb.Gettext, "errors", msg, opts)
    end
  end
